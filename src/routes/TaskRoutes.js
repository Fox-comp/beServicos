...
//DELIVERY IMPORT PIZZARIA
const PedidosPizzaria = require('../controller/delivery_pizzaria_pedidos');
//DELIVERY AVALIACOES
...
//PEDIDOS PIZZARIA
router.post('/createPizzariaPedidos', PedidosPizzaria.createPedido);
